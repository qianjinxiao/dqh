...
<div class="">
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getName()}-orderable" data-id="{$this->getKey()}" data-direction="1">
    ...
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getName()}-orderable" data-id="{$this->getKey()}" data-direction="0">
...
EOT;
    ...
    protected function script()
    {
        return <<<JS
        Dcat.grid.Orderable({
            button: '.{$this->grid->getName()}-orderable',
