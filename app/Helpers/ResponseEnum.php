...
class ResponseEnum
{
    ...
    //微信登陆
    const WECHAT_UN_GET_USERINFO=[31011,'参数错误，未获取用户信息'];
    const WECHAT_UNBIND=[31011,'未绑定用户'];
    /*-------------------------------------------------------------------------------------------*/
    ...
    const CLIENT_USERNAME_UNDEFIND = [400210, '账号不存在'];
    const CLIENT_PASSWORD_ERROR = [400210, '密码错误'];
