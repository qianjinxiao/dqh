    ...
    Calendar.prototype = {
        ...
        init: function () {
            ...
            el.on("click", ".year-item", function (e) {
                ...
                thisdate=opts.newDate.getFullYear()+"-"+(opts.newDate.getMonth() + 1)+"-01"
                window.location.href="/admin/small_reservoirs/project/routine_inspections?now_date="+thisdate
            })
            //触发选择月份
            ...
            el.on("click", ".month-item", function (e) {
                ...
                thisdate=opts.newDate.getFullYear()+"-"+monthNum+"-01"
                window.location.href="/admin/small_reservoirs/project/routine_inspections?now_date="+thisdate
